  ...
  return (
    <div className="page-content fade-in">
      ...
      {showModal && (
        ...
        >
          <div ref={modalRef} className="card-gradient fade-in" style={{ width: '100%', maxWidth: 480, margin: '16px', maxHeight: 'calc(100vh - 32px)', overflowY: 'auto', padding: isMobile ? 20 : 32 }}>
